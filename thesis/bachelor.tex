%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Vorlage für eine Diplomarbeit für den Fachbereich 
...
\begin{document}
\pagestyle{empty}
\include{Sections/Titelblatt}               % und eidesstattliche Erklärung
...
\cleardoublepage
\include{Sections/ExperimentelleValidierung}
\include{Sections/Schlussbetrachtungen}



\begin{appendix}
\include{Sections/Anhang_Mathematik}                 % A
\include{Sections/Anhang_FormatDerParameterdateien}  % B
\include{Sections/Anhang_Quelltexte}                 % C
\include{Sections/Anhang_Datenblaetter}              % D
\include{Sections/Anhang_Glossar}                    % E
\end{appendix}
