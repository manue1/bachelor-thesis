...
Generic Routing Encapsulation (GRE) tunnels are used with Open vSwitch \cite{gre-rdo} to encapsulate isolated layer 2 network traffic between compute nodes. This helps enabling tenant networks in Neutron without the need configure a switch to trunk a range of VLANs.
...
% % Add a graphic that contains a network setup with all bridges here!! % %
% % Also describe which bridges are needed and how they interface with the IP namespaces 
